...
directions = [
    "Соғлиқни сақлаш", "Таълим", "Транспорт", "Экология", "Маҳалла", "Коррупция", "Энергетика",
    "Тоза ичимлик суви", "Ёшлар сиёсати",  
    "Қурилиш", "Ташқи иқтисод",  "Бюджет",  "Маданият", "Туризм", "Спорт",
    "Қишлоқ хўжалиги", "Солиқ",  "Инвестиция", "Ижтимоий ҳимоя"
   ,  "Жамоат транспорти", "Чиқинди", "Шаҳарсозлик", "Ижро ҳокимият",
    "Суд", "Ички ишлар"
 ]
